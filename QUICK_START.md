...
→ 4. 물체 집기 → 5. 안전 위치 상승 → 6. 베이스 이동
→ 7. 최종 위치 [350, 0, 물건Z좌표, 회전값] 이동
→ 8. 물체 배치 (그리퍼 해제) ← 🆕 새로 추가!
```

**예상 로그 출력:**
```
1/8. 안전 위치로 이동: [292, -188, -65.0, -59]
2/8. 그리퍼 열기
3/8. 의자 위치로 하강: [292, -188, -115, -59]
4/8. 의자 집기 - 그리퍼 활성화
5/8. 물체를 들고 안전 위치로 상승
6/8. 베이스 위치로 이동: [300, -30, 5, 0]
7/8. 최종 배치 위치로 이동: [350, 0, -115, -59]
8/8. 의자 배치 완료 - 그리퍼 해제 ← 🆕
[SUCCESS] 의자 픽업 및 배치 시퀀스 완료!
[INFO] 최종 위치: [350, 0, -115, -59] (물체 배치 완료)
```
